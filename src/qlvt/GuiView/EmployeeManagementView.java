...
public class EmployeeManagementView extends JPanel {
    ...
    private void initComponents() throws SQLException {
        ...
        DefaultTableModel model = new DefaultTableModel(new Object[]{"Mã nhân viên",  "Họ tên", "Chức vụ" , "Chi nhánh","Quyền", "Mật khẩu"}, 0);
        ...
        employeeTable.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (selectedRow != -1) {
                    ...
                    txtchucVu.setText(model.getValueAt(selectedRow, 2).toString());
                    txtmaChiNhanh.setText(model.getValueAt(selectedRow, 3).toString());
                    txtphanQuyen.setText(model.getValueAt(selectedRow, 4).toString());
                    txtmatKhau.setText(model.getValueAt(selectedRow, 5).toString());
                }
            }
        });
        ...
        for (JButton button : new JButton[]{addButton, editButton, deleteButton, removeButton}) {
            ...
            {
                deleteButton.addActionListener(e -> deleteEmployeeTong());
            } else
            {
                deleteButton.addActionListener(e -> deleteEmployee());
            }
